                ...
                <div className="container-fluid">
                       ...
                       <div className="row">
                        <div className="col-xl-6 d-flex justify-content-start">
                          <h4 className="fw-bold text-start">Add Customer Account Master</h4>
                        </div>
                        ...
                        >
                          <MenuItem onClick={handleClose}>
                            <Link to="/account_master" style={{ textDecoration: 'none', color: 'inherit' }}>
                              Customer Master
                            </Link>
                          </MenuItem>
                          <MenuItem onClick={handleClose}>
                            <Link to="/add_supplier_master" style={{ textDecoration: 'none', color: 'inherit' }}>
                              Supplier Master
                            </Link>
                          </MenuItem>
                          <MenuItem onClick={handleClose}>
                            <Link to="/add_general_master" style={{ textDecoration: 'none', color: 'inherit' }}>
                              Journal Master
                            </Link>
                          </MenuItem>
                        </Menu>
                        ...
                        <div className="row">
                          <div className="col-xl-12 mx-auto mt-2">
                            <div className="row">
                                  ...
                                  <div className="col-xl-2">
                                     <TextField
                                      ...
                                      MenuProps={{
                                        PaperProps: {
                                          style: {
                                            maxHeight: 1, // Adjust this value to control when the scrollbar appears
                                            overflowY: "auto",
                                          },
                                        },
                                      }}
                                  ...
                                  <div className="col-xl-3">
                                    ...
                                    {imageError && (
                                      <span style={{ color: "red" }}>
                                        Please upload an image file not
                                        exceeding 2MB
                                      </span>
                                    )}
                                  </div>
                              ...
                              <div className="col-xl-2">
                              <Box display="flex" alignItems="center"  sx={{ fontSize: '0.875rem', m: 2 }}>
                                    <FormControl
                                        fullWidth size="small" sx={{ minWidth: 120}}
                                    >
                                      <InputLabel id="openingBalance.type-label" sx={{ fontSize: '0.875rem' }}>
                                   ...
                                   <Box display="flex" alignItems="center" sx={{ fontSize: '0.875rem', m: 2 }}>
                                          <FormControl
                                            ...
                                            sx={{ minWidth: 120 }}
                                          >
                                            <InputLabel id="rateType-label" sx={{ fontSize: '0.875rem' }}>
                                              Rate Type
                                            </InputLabel>
                                            <Select
                                   ...
                                   <Box display="flex" alignItems="center" sx={{ fontSize: '0.875rem', m: 2 }}>
                                      <FormControl
                                       fullWidth size="small" sx={{ minWidth: 120 }}
                                      >
                                        <InputLabel id="customerType-label" sx={{ fontSize: '0.875rem' }}>
                                          Customer Type
                                        </InputLabel>
                                        <Select
                                    ...
                                    >
                                      ...
                                      <div className="col-xl-3">
                                        <TextField
                                          ...
                                          value={
                                            accountData.address.houseNumber
                                          }
                                          onChange={handleChange}
                                        />
                                      </div>
                              ...
                              <div className="col-xl-12 mt-3">
                                  <span className="fw-bold mb-3" style={{ color: "rgb(34, 153, 84)", fontSize: '17px' }}>
                                    Rate Type
                                  </span>
                                  <ul className="d-flex mt-2">
                                    <li className="me-5" style={{ color: "rgb(233, 30, 99)", fontWeight: "500" }}>
                                      Rate A - Semi-Wholesaler
                                    </li>
                                    <li className="me-5" style={{ color: "gray", fontWeight: "500" }}>
                                      Rate B - Wholesaler
                                    </li>
                                    <li style={{ color: "rgb(0, 188, 212)", fontWeight: "500" }}>
                                      Rate R - Retailer
                                    </li>
                                  </ul>
                                </div>
